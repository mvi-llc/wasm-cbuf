...
const char* TokenTypeToStr(TOKEN_TYPE type) {
  switch (type) {
    ...
    CASE_TOKEN_TYPE(TK_SHORT_STRING_KEYWORD);
    CASE_TOKEN_TYPE(TK_CHAR);
    CASE_TOKEN_TYPE(TK_ENUM);
    ...
    CASE_TOKEN_TYPE(TK_STRUCT);
    CASE_TOKEN_TYPE(TK_NAMESPACE);
    CASE_TOKEN_TYPE(TK_DOUBLE_PIPE);
    CASE_TOKEN_TYPE(TK_ELSE);
